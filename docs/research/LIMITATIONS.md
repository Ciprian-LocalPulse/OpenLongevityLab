...
OpenLongevity is a reproducibility and evidence-navigation tool. It is not a clinical decision system, diagnostic model, or proof that an intervention changes human lifespan.
